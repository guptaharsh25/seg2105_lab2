public class PointCPDesign2 {
    ...
    PointCPDesign2(double r, double theta){
        this.r = r;
        this.theta = theta;
    }
    ...
    public PointCPDesign2 rotatePoint(double rotation) {
        ...
        return new PointCPDesign2(Math.sqrt(Math.pow((Math.cos(radRotation) * X) - (Math.sin(radRotation) * Y), 2) + Math.pow((Math.sin(radRotation) * X) + (Math.cos(radRotation) * Y), 2)),Math.toDegrees(Math.atan2((Math.sin(radRotation) * X) + (Math.cos(radRotation) * Y), (Math.cos(radRotation) * X) - (Math.sin(radRotation) * Y))));
    }
