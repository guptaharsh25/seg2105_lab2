...
public class CollectionTester {
    ...
    public static void main(String[] args){
        ...
        ArrayList<Integer> arrayList = CollectionTester.genRandomArrayList(CONST_SIZE);
        long end = System.currentTimeMillis();
        System.out.println("ArrayList: " + (end-start));

        start = System.currentTimeMillis();
        int[] array = CollectionTester.genRandomArray(CONST_SIZE);
        end = System.currentTimeMillis();
        System.out.println("Array: " + (end-start));

        start = System.currentTimeMillis();
        Vector<Integer> vector = CollectionTester.genRandomVector(CONST_SIZE);
        end = System.currentTimeMillis();
        System.out.println("Vector: " + (end-start) + "\n");

        //part b
        start = System.currentTimeMillis();
        CollectionTester.sumArrayList(arrayList);
        end = System.currentTimeMillis();
        System.out.println("ArrayList Iterator: " + (end-start));

        start = System.currentTimeMillis();
        CollectionTester.sumArray(array);
        end = System.currentTimeMillis();
        System.out.println("Array Iterator: " + (end-start));

        start = System.currentTimeMillis();
        CollectionTester.sumVector(vector);
        end = System.currentTimeMillis();
